      ...
      <div className="md:sticky md:top-16 md:h-[calc(100vh-64px)] md:overflow-x-hidden md:overflow-y-auto no-scrollbar">
        <div className="md:py-8">
          ...
          <header className="mb-6">
            <h1 className="text-2xl md:text-3xl text-slate-800 font-bold">Tokens Test ✨</h1>
          </header>
            ...
            <div>
              ...
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Create Token</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Add Tokens</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Burn Tokens</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Transfer Tokens</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Earn Tokens (User)</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-slate-600">Redeem Tokens (User)</span>
                  </a>
                </li>
              </ul>
            </div>
