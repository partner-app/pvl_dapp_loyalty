          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full">
              ...
              <tbody className="text-sm divide-y divide-slate-100">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.mlb.com/open-pro/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.mlb.com/simple/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">mlb.com/unlimited/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.mlb.com/twist/</div>
                  </td>
                  <td className="py-2">
